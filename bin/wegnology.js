...
const pgm = program
  .version(pkg.version)
  .description('WEGnology CLI is a command line tool to help manage your WEGnology Application and its resources.')
  .command('login', 'Log in and create your user configuration to use the other commands.')
  .command('set-token', 'Create a User API Token in your WEGnology account, then set it here to configure the command line tool.')
