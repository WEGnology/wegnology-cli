...
describe('#Watch Files', () => {
  ...
  it('should process files in the order they were queued', async function() {
    ...
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .post('/applications/654259a38ba86eb06852263c/files', { name: 'help.txt', parentDirectory: '/', type: 'file', fileSize: 9, contentType: 'text/plain' })
    ...
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .post('/applications/654259a38ba86eb06852263c/files', { name: 'yo.txt', parentDirectory: '/', type: 'file', fileSize: 9, contentType: 'text/plain' })
      .query({ _actions: 'false', _links: 'true', _embedded: 'true' })
      .reply(201, {
        name: 'newFile.txt',
        parentDirectory: '/',
    ...
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .post('/applications/654259a38ba86eb06852263c/files', { name: 'myFile.txt', parentDirectory: '/mine', type: 'file', fileSize: 9, contentType: 'text/plain' })
      .query({ _actions: 'false', _links: 'true', _embedded: 'true' })
      .reply(201, {
        name: 'newFile.txt',
        parentDirectory: '/',
