...
describe('#ExperienceBootstrap', () => {
  it('should skip bootstrapping when skipping and confirming with a no', async () => {
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .get('/applications/654259a38ba86eb06852263c')
      .query({ _actions: 'false', _links: 'true', _embedded: 'true' })
      .reply(200, {
        id: '654259a38ba86eb06852263c',
        applicationId: '654259a38ba86eb06852263c',
        name: '[wegnology-cli] Library tests',
        ftueTracking: [{
          name: 'experience',
          status: 'skipped',
          version: 2
    ...
    await buildConfig();
    await bootstrap();
    message.should.equal(`${pad(c.yellow('Skip'), 13)}\tBootstrapping for this application [wegnology-cli] Library tests.`);
  });
  it('should not bootstrap if it has already been completed', async () => {
    ...
    await buildConfig();
    await bootstrap();
    message.should.equal(`${pad(c.yellow('Cannot Complete'), 13)}\tBootstrapping has already been completed for [wegnology-cli] Library tests`);
  });
  it('should log out that pages were downloaded and bootstrapping completed', async () => {
    ...
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .patch('/applications/654259a38ba86eb06852263c/experience/bootstrap', {})
      .query({ _actions: 'false', _links: 'true', _embedded: 'true' })
    ...
    messages.should.deepEqual([
      ...
      `${pad(c.gray('Experience URL'), 13)}\thttps://aSlug.on.wegnology.com/aSuffix`,
