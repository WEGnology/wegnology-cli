...
describe('#ExperienceLayout', () => {
  ...
  it('it should update a one page\'s layout', async () => {
    ...
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .patch('/applications/654259a38ba86eb06852263c/experience/views/5b92975d376bb800087d1f50', { layoutId: '5c0a9a163fb78400095ec089' })
      .query({ _actions: 'false', _links: 'true', _embedded: 'true' })
      .reply(200, {
        name: 'Home Page', description: 'Here is an example home page, which renders only for logged-in users. Within the workflow that renders this template, we redirect to the Login page if the experience user is not signed in. This page renders within your Example Layout at the position of the {{ page }} tag.', viewType: 'page', layoutId: '5c0a9a163fb78400095ec089', body: "{{#fillSection \"metaDescription\"}}This is an example home page for your application experience.{{/fillSection}}\n<div class=\"container\">\n  <div class=\"jumbotron\">\n    <h1>Your Experience View!</h1>\n    <p class=\"lead\">\n      This is an example of a change and back down <a target=\"_blank\" href=\"https://docs.wnology.io/experiences/views/\">Experience View</a> we've built for you. It provides many of the common\n      components that most web pages have, like a header, footer, and navigation. You can use this\n      as a launching point for your own custom user interfaces.\n    </p>\n  </div>\n  <p>\n    All Experiences Views start with a <a href=\"https://docs.wnology.io/experiences/views/#layouts\">Layout</a>. The layout includes common items found on\n    all pages, like a header and footer. <a href=\"https://docs.wnology.io/experiences/views/#pages\">Pages</a> are then rendered inside\n    the layout.\n  </p>\n  <p>There are two types of pages available: <a target=\"_blank\" href=\"https://docs.wnology.io/experiences/views/#custom-pages\">Custom</a> and <a target=\"_blank\" href=\"https://docs.wnology.io/experiences/views/#dashboard-pages\">Dashboard</a>.\n    What you're reading now is an example of a custom page. Dashboard pages allow you to embed an\n    existing dashboard, which is a fast way to publish data to your Experience Users.\n  </p>\n  <p>\n    For additional information, please read the <a target=\"_blank\" href=\"https://docs.wnology.io/experiences/walkthrough/views/overview/\">Experience View Walkthrough</a>, which includes\n    detailed instructions for how to build a complete example that includes both custom and\n    dashboard pages.\n  </p>\n  <p>\n    This example is created using <a href=\"https://getbootstrap.com/docs/3.3/\" target=\"_blank\">Twitter Bootstrap</a>, which\n    provides many components, styles, and utilities that make building web pages simple.\n  </p>\n</div>", applicationId: '654259a38ba86eb06852263c', creationDate: '2018-09-07T15:21:01.465Z', lastUpdated: '2018-12-07T16:51:59.784Z', viewTags: {}, lastUpdatedById: '59a41ff6b36c040007c6e2eb', lastUpdatedByType: 'user', experienceViewId: '5b92975d376bb800087d1f50', id: '5b92975d376bb800087d1f50', version: 'develop', layoutName: 'Another Layout', _type: 'experienceView', _links: { self: { href: '/applications/654259a38ba86eb06852263c/experience/views/5b92975d376bb800087d1f50' } }
      }, [ 'Date',
    ...
    sinon.stub(inquirer, 'prompt').callsFake(() => {
      return Promise.resolve({ name: 'Another Layout https://app.wnology.io/applications/654259a38ba86eb06852263c/experience/versions/develop/views/layouts/5c0a9a163fb78400095ec089' });
    });
  ...
  it('should update multiple pages layouts', async () => {
    ...
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .patch('/applications/654259a38ba86eb06852263c/experience/views/5b92975dc2f8de0006e2ca94', { layoutId: '5c0a9a163fb78400095ec089' })
      .query({ _actions: 'false', _links: 'true', _embedded: 'true' })
      .reply(200, {
        name: 'Log In', layoutId: '5c0a9a163fb78400095ec089', applicationId: '654259a38ba86eb06852263c', creationDate: '2018-09-07T15:21:01.465Z', lastUpdated: '2018-12-07T16:51:59.784Z', viewTags: {}, lastUpdatedById: '59a41ff6b36c040007c6e2eb', lastUpdatedByType: 'user', experienceViewId: '5b92975d376bb800087d1f50', id: '5b92975d376bb800087d1f50', version: 'develop', layoutName: 'Another Layout', _type: 'experienceView', _links: { self: { href: '/applications/654259a38ba86eb06852263c/experience/views/5b92975d376bb800087d1f50' } }
      }, [ 'Date',
        'Fri, 07 Dec 2018 16:51:59 GMT',
        'Content-Type',
        'application/json',
    ...
    sinon.stub(inquirer, 'prompt').callsFake((config) => {
      if (config[0].type === 'list') {
        ...
        return Promise.resolve({
          pageKey: [
            'Home Page https://app.wnology.io/applications/654259a38ba86eb06852263c/experience/versions/develop/views/pages/5b92975d376bb800087d1f50',
            'Log In https://app.wnology.io/applications/654259a38ba86eb06852263c/experience/versions/develop/views/pages/5b92975dc2f8de0006e2ca94'
          ]
        });
      }
    });
  ...
  it('should update multiple pages layouts to null', async () => {
    ...
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .patch('/applications/654259a38ba86eb06852263c/experience/views/5b92975d376bb800087d1f50', { layoutId: null })
      .query({ _actions: 'false', _links: 'true', _embedded: 'true' })
      .reply(200, {
        name: 'Home Page', description: 'Here is an example home page, which renders only for logged-in users. Within the workflow that renders this template, we redirect to the Login page if the experience user is not signed in. This page renders within your Example Layout at the position of the {{ page }} tag.', viewType: 'page', layoutId: '5c0a9a163fb78400095ec089', body: "{{#fillSection \"metaDescription\"}}This is an example home page for your application experience.{{/fillSection}}\n<div class=\"container\">\n  <div class=\"jumbotron\">\n    <h1>Your Experience View!</h1>\n    <p class=\"lead\">\n      This is an example of a change and back down <a target=\"_blank\" href=\"https://docs.wnology.io/experiences/views/\">Experience View</a> we've built for you. It provides many of the common\n      components that most web pages have, like a header, footer, and navigation. You can use this\n      as a launching point for your own custom user interfaces.\n    </p>\n  </div>\n  <p>\n    All Experiences Views start with a <a href=\"https://docs.wnology.io/experiences/views/#layouts\">Layout</a>. The layout includes common items found on\n    all pages, like a header and footer. <a href=\"https://docs.wnology.io/experiences/views/#pages\">Pages</a> are then rendered inside\n    the layout.\n  </p>\n  <p>There are two types of pages available: <a target=\"_blank\" href=\"https://docs.wnology.io/experiences/views/#custom-pages\">Custom</a> and <a target=\"_blank\" href=\"https://docs.wnology.io/experiences/views/#dashboard-pages\">Dashboard</a>.\n    What you're reading now is an example of a custom page. Dashboard pages allow you to embed an\n    existing dashboard, which is a fast way to publish data to your Experience Users.\n  </p>\n  <p>\n    For additional information, please read the <a target=\"_blank\" href=\"https://docs.wnology.io/experiences/walkthrough/views/overview/\">Experience View Walkthrough</a>, which includes\n    detailed instructions for how to build a complete example that includes both custom and\n    dashboard pages.\n  </p>\n  <p>\n    This example is created using <a href=\"https://getbootstrap.com/docs/3.3/\" target=\"_blank\">Twitter Bootstrap</a>, which\n    provides many components, styles, and utilities that make building web pages simple.\n  </p>\n</div>", applicationId: '654259a38ba86eb06852263c', creationDate: '2018-09-07T15:21:01.465Z', lastUpdated: '2018-12-07T16:51:59.784Z', viewTags: {}, lastUpdatedById: '59a41ff6b36c040007c6e2eb', lastUpdatedByType: 'user', experienceViewId: '5b92975d376bb800087d1f50', id: '5b92975d376bb800087d1f50', version: 'develop', layoutName: 'Another Layout', _type: 'experienceView', _links: { self: { href: '/applications/654259a38ba86eb06852263c/experience/views/5b92975d376bb800087d1f50' } }
      }, [ 'Date',
    ...
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .patch('/applications/654259a38ba86eb06852263c/experience/views/5b92975dc2f8de0006e2ca94', { layoutId: null })
      .query({ _actions: 'false', _links: 'true', _embedded: 'true' })
      .reply(200, {
        name: 'Log In', layoutId: '5c0a9a163fb78400095ec089', applicationId: '654259a38ba86eb06852263c', creationDate: '2018-09-07T15:21:01.465Z', lastUpdated: '2018-12-07T16:51:59.784Z', viewTags: {}, lastUpdatedById: '59a41ff6b36c040007c6e2eb', lastUpdatedByType: 'user', experienceViewId: '5b92975d376bb800087d1f50', id: '5b92975d376bb800087d1f50', version: 'develop', layoutName: 'Another Layout', _type: 'experienceView', _links: { self: { href: '/applications/654259a38ba86eb06852263c/experience/views/5b92975d376bb800087d1f50' } }
      }, [ 'Date',
