...
describe('Experience Commands', () => {
  ...
  it('should run get status', async () => {
    ...
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      ...
      .reply(200, {
        ...
        _links: { self: { href: '/applications/654259a38ba86eb06852263c/experience/views' } }
      }, [ 'Date',
  ...
  it('should run get status, download, and not upload because of conflicts', async function() {
    ...
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      ...
      .reply(200, {
        count: 10,
        items: [{
          name: 'Dashboard Stream Only', viewType: 'page', layoutId: '59f201ed95c9e70007b7ffc3', body: '', applicationId: '654259a38ba86eb06852263c', creationDate: '2017-12-15T16:14:32.516Z', lastUpdated: '2018-10-19T17:08:04.289Z', viewTags: {}, description: '', lastUpdatedById: '56c7420e63b022010029fcd3', lastUpdatedByType: 'user', experienceViewId: '5a33f4e847308400073d07f4', id: '5a33f4e847308400073d07f4', version: 'develop', layoutName: 'Example Layout', _type: 'experienceView', _links: { self: { href: '/applications/654259a38ba86eb06852263c/experience/views/5a33f4e847308400073d07f4' } }
        }, {
          name: 'Dashboard Transferred', viewType: 'page', body: "{{ element \"dashboard\" dashboardId=(template \"{{'5a37d72d47308400073d07f6'}}\") ctx=(obj deviceId-0=(template \"59021caf9e2a180001268984\")) theme=(template \"light\") time=(template \"\") }}", applicationId: '654259a38ba86eb06852263c', creationDate: '2017-12-18T16:16:34.640Z', lastUpdated: '2018-10-15T17:07:28.168Z', viewTags: {}, description: 's', lastUpdatedById: '56c7420e63b022010029fcd3', lastUpdatedByType: 'user', experienceViewId: '5a37e9e247308400073d07fb', id: '5a37e9e247308400073d07fb', version: 'develop', _type: 'experienceView', _links: { self: { href: '/applications/654259a38ba86eb06852263c/experience/views/5a37e9e247308400073d07fb' } }
        }, {
          name: 'Example Layout', description: 'Example layout using Twitter Bootstrap v3 scripts, stylesheets and scaffolding. You may create any number of layouts and reference them when rendering your pages, and you can include any common CSS or JavaScript in the layout.', viewType: 'layout', body: '<!doctype html>\n<!--[if lt IE 7]>      <html class="lt-ie9 lt-ie8 lt-ie7" lang=""> <![endif]-->\n<!--[if IE 7]>         <html class="lt-ie9 lt-ie8" lang=""> <![endif]-->\n<!--[if IE 8]>         <html class="lt-ie9" lang=""> <![endif]-->\n<!--[if gt IE 8]><!--> <html lang=""> <!--<![endif]-->\n  <head>\n    <meta charset="utf-8">\n    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">\n    <title>{{ experience.page.name }} | My Experience</title>\n    <meta name="description" content="">\n    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">\n    <link rel="icon" type="image/x-icon" href="http://localapp.wnology.io:8080/images/embree/favicon.ico" />\n    <!-- Latest compiled and minified CSS -->\n    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">\n  </head>\n  <body>\n    <!--[if lt IE 8]>\n      <p class="browserupgrade">You are using an <strong>outdated</strong> browser. Please <a href="http://browsehappy.com/">upgrade your browser</a> to improve your experience.</p>\n    <![endif]-->\n    <nav class="navbar navbar-default" role="navigation" style="border-width: 0 0 1px; border-radius: 0; -webkit-border-radius:0;">\n      <div class="container-fluid">\n        <div class="navbar-header">\n          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">\n            <span class="sr-only">Toggle navigation</span>\n            <span class="icon-bar"></span>\n            <span class="icon-bar"></span>\n            <span class="icon-bar"></span>\n          </button>\n          <a class="navbar-brand" href="/home-H1gSgMYkCZ" style="padding-top:0; padding-bottom:0;">\n            <img alt="Logo" style="margin-top:13px; height: 24px;" src="http://localapp.wnology.io:8080/images/embree/embree_sm.png">\n          </a>\n        </div>\n        <div id="navbar" class="navbar-collapse collapse">\n          <ul class="nav navbar-nav navbar-left">\n            <li><a href="#">Link</a></li>\n            <li><a href="#">Link</a></li>\n            <li><a href="#">Link</a></li>\n            <li><a href="#">Link</a></li>\n          </ul>\n          {{component "userIndicator"}}\n        </div>\n      </div>\n    </nav>\n    {{ page }}\n    <hr>\n    <footer>\n      <p style="text-align:center">&copy; 2017. All rights reserved.</p>\n    </footer>\n    <!-- Bootstrap core JavaScript\n    ================================================== -->\n    <!-- Placed at the end of the document so the pages load faster -->\n    <script src="https://code.jquery.com/jquery-3.2.1.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous"></script>\n    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>\n    {{component "gaTracking" "UA-XXXXX-X"}}\n  </body>\n</html>', applicationId: '654259a38ba86eb06852263c', creationDate: '2017-10-26T15:40:29.160Z', lastUpdated: '2018-10-12T23:01:04.713Z', viewTags: {}, lastUpdatedById: '56c7420e63b022010029fcd3', lastUpdatedByType: 'user', experienceViewId: '59f201ed95c9e70007b7ffc3', id: '59f201ed95c9e70007b7ffc3', version: 'develop', _type: 'experienceView', _links: { self: { href: '/applications/654259a38ba86eb06852263c/experience/views/59f201ed95c9e70007b7ffc3' } }
  ...
  it('should run get status, download, and upload', async function() {
    ...
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .delete('/applications/654259a38ba86eb06852263c/experience/views/59f201edf21ee00007a93a96')
      ...
      .reply(200, { success: true },
        [ 'Date',
          ...
          'max-age=31536000' ]);
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .delete('/applications/654259a38ba86eb06852263c/experience/views/59f201ed95c9e70007b7ffc7')
      .query({ _actions: 'false', _links: 'true', _embedded: 'true' })
      .reply(200, { success: true },
        [ 'Date',
          'Thu, 18 Oct 2018 19:37:34 GMT',
    ...
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .patch('/applications/654259a38ba86eb06852263c/experience/views/59f24b75ae64aa0007e7618a', { body: 'hello world...' })
      .query({ _actions: 'false', _links: 'true', _embedded: 'true' })
      .reply(200, {
        name: 'dash', viewType: 'page', layoutId: '59f201ed95c9e70007b7ffc3', body: 'hello world...', applicationId: '654259a38ba86eb06852263c', creationDate: '2017-10-26T20:54:13.012Z', lastUpdated: '2018-09-18T21:46:00.140Z', viewTags: {}, description: '', experienceViewId: '59f24b75ae64aa0007e7618a', id: '59f24b75ae64aa0007e7618a', version: 'develop', layoutName: 'Example Layout', _type: 'experienceView', _links: { self: { href: '/applications/654259a38ba86eb06852263c/experience/views/59f24b75ae64aa0007e7618a' } }
      },
      [ 'Date',
        'Thu, 18 Oct 2018 19:37:34 GMT',
        'Content-Type',
        ...
        'max-age=31536000' ]);
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .patch('/applications/654259a38ba86eb06852263c/experience/views/5a33f4e847308400073d07f4', { body: 'Oh hi mark...' })
      .query({ _actions: 'false', _links: 'true', _embedded: 'true' })
      .reply(200, {
        name: 'dash', viewType: 'page', layoutId: '59f201ed95c9e70007b7ffc3', body: 'hello world...', applicationId: '654259a38ba86eb06852263c', creationDate: '2017-10-26T20:54:13.012Z', lastUpdated: '2018-09-18T21:46:00.140Z', viewTags: {}, description: '', experienceViewId: '59f24b75ae64aa0007e7618a', id: '59f24b75ae64aa0007e7618a', version: 'develop', layoutName: 'Example Layout', _type: 'experienceView', _links: { self: { href: '/applications/654259a38ba86eb06852263c/experience/views/59f24b75ae64aa0007e7618a' } }
      },
    ...
    nock('https://api.app.wnology.io:443', { encodedQueryParams: true })
      .post('/applications/654259a38ba86eb06852263c/experience/views', { body: 'a whole new page!', viewType: 'page', name: 'newPage' })
      .query({ _actions: 'false', _links: 'true', _embedded: 'true' })
      .reply(200, {
